...
<div class="es-content">
    ...
    <!-- Filter bar -->
    <div class="es-card">
        <form method="get" action="${pageContext.request.contextPath}/reporting/reports/events"
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:20px;">
        ...
        <div class="es-card">
            <div class="card-header">
                <h3>Events by Month (${pageContext.request.contextPath})</h3>
            </div>
        ...
        <div class="card-header">
            <h3>Event Details
                <c:if test="${not empty filterStatus}">
                    â€” Filtered: <span class="es-badge badge-pending">${filterStatus}</span>
                </c:if>
            </h3>
            <span style="font-size:12px;color:#718096;">${events.size()} record(s)</span>
        </div>
