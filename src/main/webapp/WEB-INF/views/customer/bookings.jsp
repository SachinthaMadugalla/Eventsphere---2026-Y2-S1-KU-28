...
<div class="es-content">
    ...
    <div class="page-header">
        ...
        <div class="breadcrumb">
            <a href="${fn:escapeXml(pageContext.request.contextPath)}/customer/dashboard">Dashboard</a> &rsaquo; My Bookings
        </div>
    </div>
        ...
        <c:choose>
            <c:when test="${empty events}">
                <div class="es-empty">
                    ...
                    <a href="${fn:escapeXml(pageContext.request.contextPath)}/customer/booking/new"
