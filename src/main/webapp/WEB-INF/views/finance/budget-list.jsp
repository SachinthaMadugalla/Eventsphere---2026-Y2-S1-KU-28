...
<div class="es-content">
    ...
    <div class="es-card">
        <div class="card-header"><h3>Event Budgets</h3><a href="${fn:escapeXml(pageContext.request.contextPath)}/finance/budget/create" class="btn btn-accent btn-sm">+ Create Budget</a></div>
